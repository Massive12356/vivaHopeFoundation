...
const AboutUs: React.FC = () => {
  return (
    <>
      ...
      {/* Mission & Vision */}
      <ScrollAnimation>
        <section className="py-20 bg-gradient-to-br from-gray-50 to-white dark:from-neutral-900 dark:to-neutral-800">
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-white to-gray-50 dark:from-neutral-800 dark:to-neutral-900 rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-neutral-700 relative overflow-hidden group"
                >
                  <div className="absolute top-0 right-0 w-32 h-32 bg-primary-500/10 rounded-full blur-3xl -mr-16 -mt-16 transition-opacity group-hover:opacity-75"></div>
                  <div className="relative z-10">
                    <div className="bg-gradient-to-br from-primary-500 to-primary-600 p-4 rounded-xl w-fit mb-6 shadow-lg">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                      Our mission is to equip young women, girls, and youth with high-demand skills, practical knowledge, tools, and confidence to build thriving businesses or secure living-wage employment. Through this work, VivaHope Foundation helps young people break the cycle of poverty and build sustainable futures, locally and globally
                    </p>
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-white to-gray-50 dark:from-neutral-800 dark:to-neutral-900 rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-neutral-700 relative overflow-hidden group"
                >
                  <div className="absolute top-0 right-0 w-32 h-32 bg-secondary-500/10 rounded-full blur-3xl -mr-16 -mt-16 transition-opacity group-hover:opacity-75"></div>
                  <div className="relative z-10">
                    <div className="bg-gradient-to-br from-secondary-500 to-secondary-600 p-4 rounded-xl w-fit mb-6 shadow-lg">
              ...
              {/* Purpose Card - Centered Below */}
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                whileHover={{ scale: 1.02, y: -8 }}
                className="max-w-2xl w-full bg-gradient-to-br from-white to-gray-50 dark:from-neutral-800 dark:to-neutral-900 rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-neutral-700 relative overflow-hidden group"
              >
                <div className="absolute top-0 left-0 w-40 h-40 bg-primary-500/10 rounded-full blur-3xl -ml-20 -mt-20 transition-opacity group-hover:opacity-75"></div>
                <div className="absolute bottom-0 right-0 w-40 h-40 bg-secondary-500/10 rounded-full blur-3xl -mr-20 -mb-20 transition-opacity group-hover:opacity-75"></div>
                <div className="relative z-10">
                  <div className="flex justify-center mb-6">
                    <div className="bg-gradient-to-br from-primary-500 to-secondary-600 p-4 rounded-xl shadow-lg">
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed text-center">
                    We exist to disrupt generational poverty by combining education, workforce development, and economic empowerment programs that equip youth with practical skills, confidence, and pathways to livable wages.
                  </p>
                </div>
              </motion.div>
            </div>
